...
This module will download dataset from https://dataset.bj.bcebos.com/cifar/cifar-10-python.tar.gzand https://dataset.bj.bcebos.com/cifar/cifar-100-python.tar.gz, parse train/test set into
