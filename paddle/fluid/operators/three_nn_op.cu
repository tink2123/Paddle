...
template <typename T>
__global__ void KeThreeNNFw(T* distance, int* idx, const T* input,
                            const T* known, const float eps, const int b,
...
REGISTER_OP_CUDA_KERNEL(three_nn, ops::ThreeNNOpCUDAKernel<float>,
